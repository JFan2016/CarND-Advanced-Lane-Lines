...
def sliding_window(undist,warped_binary):
    ...
    # return out_img,left_fit,right_fit,ploty,left_fitx,right_fitx,left_curverad,right_curverad
...
# def visualize(out_img,left_fit,right_fit,ploty,left_fitx,right_fitx):
#     plt.imshow(out_img)
...
# def targeted_search(warped_binary,left_fit,right_fit,ploty,left_fitx,right_fitx):
